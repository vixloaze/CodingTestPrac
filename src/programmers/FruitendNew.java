...
수정한 부분:
    1. 굳이 배열을 내림차순으로 정렬할 필요가 있을까? -> 올림차순으로 하고 반대로 진행하면 되지 않을까?
    2. 굳이 while문 무한루프문으로 작성할 필요가 있을까? -> for문으로 변경
*/
public class FruitendNew {
    ...
    public static void main(String[] args) {
        FruitendNew fruitendNew = new FruitendNew();
        int[] score1, score2;
        score1 = new int[]{1, 2, 3, 1, 2, 3, 1};
        score2 = new int[]{4, 1, 2, 2, 4, 4, 4, 4, 1, 2, 4, 2};
        System.out.println(fruitendNew.solution(3,4,score1));
        System.out.println(fruitendNew.solution(4,3,score2));
    }
}
